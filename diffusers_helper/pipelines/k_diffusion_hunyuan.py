...
def sample_hunyuan(
    ...
    # print('latent size: ' , (batch_size * 16 * ((frames + 3) // 4) * (height // 8) * (width // 8) * 4)/(1024*1024), ' Gbytes')
    ...
    distilled_guidance = torch.tensor([distilled_guidance_scale * 1000.0] * batch_size, device=torch.device('cuda'), dtype=dtype)
